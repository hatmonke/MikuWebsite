      ...
      <div className="space-y-4 bg-black rounded-3xl bg-opacity-50 p-12">
        <div>
          <p className="font-bold text-3xl">
            ...
            <p className="pt-8">We wish to provide value to the
            MIKU through the release of utilities such as our Miku Swap and Miku
            Lock Platform to help kickstart BSC as a safe environment for the
            degen scene and fight the potential for rugs.</p>
          </p>
        </div>
      </div>
    </>
